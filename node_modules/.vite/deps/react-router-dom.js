...
import { require_react_dom } from "./react-dom-X2OeCI49.js";

//#region node_modules/react-router/dist/development/chunk-OIYGIGL5.mjs
...
function useRoute(...args) {
	...
	const state = useDataRouterState("useRouteLoaderData");
	if (state.matches.find(({ route: route2 }) => route2.id === id) === void 0) return void 0;
	return {
...
try {
	if (isBrowser) window.__reactRouterVersion = "7.9.4";
} catch (e) {}
...
//#endregion
//#region node_modules/react-router/dist/development/chunk-WY5IRSCW.mjs
